...
\usepackage{import}                 % Relative path inputs
...
\usepackage{amsthm}
\usepackage[qm]{qcircuit}			% Quantum circuits
\usepackage[ruled,linesnumbered,lined,commentsnumbered]{algorithm2e}     % Algorithms
...
\usetikzlibrary{external}             % Tikzexternalize
...
\ifnum\thesisChapterStyle=1
	...
	\titlespacing{\chapter}{0pt}{0pt}{\parskip} \fi
...
\addto{\captionsenglish}{\renewcommand{\listalgorithmname}{List of algorithms}}
...
\newcommand{\backgroundpic}[3]{
	\put(#1,#2){
		\parbox[b][\paperheight]{\paperwidth}{ \centering
