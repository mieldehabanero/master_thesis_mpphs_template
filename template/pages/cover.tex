...
\begin{titlepage}
	...
	\setlength{\parskip}{1.5cm} \ifx\thesisCoverFigure\undefined \vspace{5.5cm} % NOTE: 1cm (1.5cm) with (without) division (below department)% increase space if there is no figure
